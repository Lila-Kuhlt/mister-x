...
import "./SVGMap.css"
import { useMap, Tooltip, Marker, MapContainer, TileLayer } from 'react-leaflet'
...
function ResetBoundsButton() {
  const resetBounds = () => { map.fitBounds(viewBounds) }
  const map = useMap()

  return <div className="leaflet-top leaflet-center">
    <button
...
export default function SVGMap(props: { trains: Train[], teams: Team[], mrX: Team }) {
  console.log(props);
