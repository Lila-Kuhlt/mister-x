export const TextInput = (
  { className, onTextChange, trim, ...props }: React.InputHTMLAttributes<HTMLInputElement> & {
...
export function DropDown<T extends string>(
  { className, items, onItemChange, ...props }: React.SelectHTMLAttributes<HTMLSelectElement> & {
    items: T[];
